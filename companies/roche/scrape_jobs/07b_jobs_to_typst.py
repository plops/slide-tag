...
def jobs_to_typst(
    ...
    """
    if df is None:
        log.warn("jobs_to_typst: no dataframe provided")
        return
...
parser = argparse.ArgumentParser(
    description="Generate Typst document for candidate-matched jobs with new job highlighting."
)
parser.add_argument(
    "--previous-date",
    type=str,
