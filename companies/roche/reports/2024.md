...
They are listed on this page: [Roche Jobs related to Slide-Tag](https://github.com/plops/slide-tag/blob/main/companies/roche/scrape_jobs/high_relevance_jobs.md)
...
The following tables summarize key roles at Roche, grouped by function. Each entry highlights the position's core contribution to developing or applying technologies like Slide-tag, along with the essential skills and the group it belongs to.

---

### **1. Computational Biology & Data Science**
*(Roles focused on analyzing, interpreting, and building tools for complex spatial and -omics data)*

| Role / Job ID | Core Contribution to Spatial Genomics (Slide-tag) | Key Skills & Technologies | Supervisory Group |
| :--- | :--- | :--- | :--- |
| **Head of Computational Biology**<br>(202507-117766) | Sets the strategic vision for using spatial & multi-omics data to discover new drug targets and biomarkers in Neurology & Ophthalmology. | PhD, 10+ yrs exp, Bioinformatics, Biostatistics, Data Science, Leadership | GTA Analytics |
| **Group Leader, Imaging Data**<br>(202507-117910) | Leads team to integrate spatial imaging with -omics data from clinical trials to identify patient biomarkers and understand disease. | PhD, 5+ yrs exp, Biomedical Image Analysis, AI/ML, Team Leadership | GTAE Computational CoE |
| **Junior Group Leader, Comp. Bio**<br>(202507-118298) | Leads research focused on computational morphometry, integrating high-throughput imaging with single-cell genomics to analyze human model systems. | Postdoc exp, Computer Vision, AI, Causal Inference, Human Model Systems | PHD Scientific Operations |
| **Head of Scientific Computing**<br>(202507-118026) | Builds and scales the high-performance computing (HPC) and cloud infrastructure required to process and analyze massive spatial genomics datasets. | 12+ yrs exp, HPC, Cloud (AWS/Azure/GCP), AI/ML infrastructure, Leadership | GTB Data & Digital |
| **Principal Scientific SW Engineer**<br>(202508-120588) | Develops software and interactive visualizations to explore complex, multimodal datasets, specifically integrating spatial transcriptomics with imaging. | PhD/MS, Python/R, Data Visualization (D3.js, Plotly), Cloud Platforms | GSFHF Computational Catalyst |
| **Senior Scientific SW Engineer**<br>(202508-120565) | Builds and productionizes scalable, reproducible bioinformatics workflows (Nextflow, WDL) for single-cell and bulk sequencing analysis. | PhD/MS, Nextflow/WDL, Python, Cloud Deployment, CI/CD, Containerization | GSFHB Computational Catalyst |

---

### **2. Genomics & Molecular Biology (Wet Lab)**
*(Roles performing the hands-on lab work to generate sequencing and molecular data)*

| Role / Job ID | Core Contribution to Spatial Genomics (Slide-tag) | Key Skills & Technologies | Supervisory Group |
| :--- | :--- | :--- | :--- |
| **Scientist, Synthetic Biology**<br>(202508-119792) | Designs and screens barcoded libraries using multi-omics and single-cell technologies—a core molecular technique for Slide-tag. | PhD, AAV Gene Therapy, Gene Editing, NGS, Single-cell Analysis, Barcoding | PRE Nucleic Acid Based Medicine |
| **Research Associate, Syn. Bio**<br>(202508-119794) | Executes experiments involving gene editing, NGS, DNA/RNA analysis, and the generation of barcoded libraries. | MS, Gene Editing, NGS (qPCR, ddPCR), FACS, Cell Culture Automation | PRE Nucleic Acid Based Medicine |
| **Research Associate, Genomics**<br>(202509-122166) | Develops, optimizes, and runs diverse bulk Next-Generation Sequencing (NGS) workflows, generating the raw data for spatial methods. | MS, 3-5 yrs exp, NGS Library Prep, Illumina & Nanopore Sequencing | PSTB Genomics 360 Lab |
| **RNA Biology Scientist**<br>(202508-120619) | Designs and executes advanced NGS-based assays to analyze RNA, a foundational part of the spatial transcriptomics workflow. | PhD/MS, 3+ yrs exp, NGS Assay Development, qPCR, RNA Biology | PREBB Oligonucleotide Research |
| **RNA Biology Associate**<br>(202508-120616) | Performs RNA purification, qPCR, and prepares samples from cultured cells and tissues for transcriptome profiling (e.g., RNA-Seq). | BS/Assoc, 3+ yrs exp, RNA handling, qPCR, Cell Culture, Tissue Processing | PREBB Oligonucleotide Research |

---

### **3. Pathology & Preclinical Science**
*(Roles providing the biological disease context and tissue samples)*

| Role / Job ID | Core Contribution to Spatial Genomics (Slide-tag) | Key Skills & Technologies | Supervisory Group |
| :--- | :--- | :--- | :--- |
| **Veterinary Clinical Pathologist**<br>(202506-115770) | Provides expert pathology assessment of preclinical tissue samples, which is essential for interpreting molecular data in its spatial context. | Board-certified (ACVP/ECVCP), Toxicological Pathology, Preclinical Models | PNUA Pathology 1 |
| **Senior Immunology Scientist**<br>(202507-117515) | Identifies safety biomarkers in tissues and develops translational strategies; spatial methods would be a key tool for this work. | PhD, 5+ yrs exp, Translational Immunology, Biomarker Discovery, NAMs | PNUF Immunosafety 1 |

---

### **4. Engineering & Technical Support**
*(Roles building the instruments, software, and automated workflows)*

| Role / Job ID | Core Contribution to Spatial Genomics (Slide-tag) | Key Skills & Technologies | Supervisory Group |
| :--- | :--- | :--- | :--- |
| **Lab Automation Scientist**<br>(202508-121393) | Automates complex sample preparation workflows for genomics on liquid handling platforms, enabling scalability and reproducibility of spatial methods. | MS/PhD, 2+ yrs exp, Lab Automation (Hamilton Venus), Python/C# | PSTF Platform Infrastructure & Ops |
| **Software Development Engineer**<br>(202507-118430) | Develops software, user interfaces, and data visualization tools for lab automation, essential for a commercial spatial genomics instrument. | BS/MS, C#, Python, JavaScript, Lab Diagnostics, GenAI/LLMs | DSRECW Core Workflow RED |
| **Development Engineer**<br>(202402-104044) | Optimizes workflows by integrating hardware, software, and robotics (Cobots) for diagnostic systems, key for building a "dark lab" platform. | BS/MS Engineering, Robotics, Python, C#, LabView | DSRMGJ NAP/qPCR & Sequencing |
| **Development Engineer**<br>(202302-103172) | Performs hands-on testing and integration of hardware and software for PCR and Sequencing instruments used in regulated environments. | BS/MS Life Science or Eng., S1/S2 lab experience | DSRMGJ NAP/qPCR & Sequencing |
| **Lab Technician**<br>(202109-125765) | Provides foundational lab support, including running molecular biology experiments and maintaining sequencing equipment. | BS Biology, Statistical Data Analysis, S1/S2 Lab Work | DSRMGJ NAP/qPCR & Sequencing |
